...
public class ActiveDirectory {
    private static String[] userAttributes = {
        ...
        "userPrincipalName","initials","department","mail","telephoneNumber","title"
    };
 ...
 //**************************************************************************
   ...
   *  or "ACME\peter").
   */
    public static Employee getUser(String username, LdapContext context) {
        try{
            ...
            if (domainName!=null){
                ...
                //String serachBase = "ou=users,dc=nigeria.firstbank.local,dc=com";
                //NamingEnumeration<SearchResult> answer = context.search( serachBase, "(& (userPrincipalName="+principalName+")(objectClass=user))", controls);
                ...
                if (answer.hasMoreElements()) {
                    ...
                    if (user!=null) {
                        User userAtt = new User(attr);
                        Employee fbnEmployee = new Employee();
                        fbnEmployee.setFirstName(userAtt.getGivenName());
                        fbnEmployee.setLastName(userAtt.getSn());
                        fbnEmployee.setEmail(userAtt.getMail());
                        fbnEmployee.setJobTitle(userAtt.getTitle());
                        fbnEmployee.setOtherNames(userAtt.getInitials());
                        return fbnEmployee;
   ...
   */
    public static class User {
        ...
        public User(Attributes attr) throws javax.naming.NamingException {
            ...
            if(!attr.get("userPrincipalName").get().equals(""))
            {
              userPrincipal = (String) attr.get("userPrincipalName").get();
            
            }
           
            if(!attr.get("cn").get().equals(null))
            {
              commonName = (String) attr.get("cn").get();
              
            }
            
            if(!attr.get("distinguishedName").get().equals(null))
            {
              distinguishedName = (String) attr.get("distinguishedName").get();
             
            }
            
            if(!attr.get("givenname").get().equals(null))
            {
              givenName = (String) attr.get("givenname").get();
             
            }
           
            if(!attr.get("sn").get().equals(null))
            {
              sn = (String) attr.get("sn").get();
              
            }
            
//            if(!attr.get("initials").get().equals(null))
//            {
//           
//              initials = (String) attr.get("initials").get();
//             
//            }
            
            //department = (String) attr.get("department").get();
            //System.out.println("department ="+department) ;
            if(!attr.get("mail").get().equals(null))
            {
